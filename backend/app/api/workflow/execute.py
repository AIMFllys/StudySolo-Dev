...
async def start_workflow_run(
    ...
    """
    from app.services.workflow_runs_service import StartRunError, start_run
    ...
    try:
        ...
        http_status = code_map.get(exc.code, status.HTTP_500_INTERNAL_SERVER_ERROR)
        detail: Any = str(exc)
