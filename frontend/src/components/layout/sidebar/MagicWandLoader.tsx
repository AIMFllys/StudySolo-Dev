/** Shared magic-wand SVG animation used by AIMessage and SkeletonLoader. */
export function MagicWandLoader() {
  return (
...
/** StudySolo AI brand icon. */
export function StudySoloIcon({ className }: { className?: string }) {
  return (
